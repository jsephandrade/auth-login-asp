        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Ip = table.Column<byte[]>(type: "varbinary(16)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompromisedAt = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    Ip = table.Column<byte[]>(type: "varbinary(16)", nullable: true),
                    UserAgentHash = table.Column<byte[]>(type: "binary(32)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_user_tenants", x => new { x.TenantId, x.UserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    ExpiresAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    RotatedFromId = table.Column<Guid>(type: "char(36)", nullable: true, collation: "ascii_general_ci"),
                    RevokedAt = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    Ip = table.Column<byte[]>(type: "varbinary(16)", nullable: true),
                    UserAgentHash = table.Column<byte[]>(type: "binary(32)", nullable: true)
                },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_audit_log_ActorUserId_CreatedAt",
                table: "audit_log",
                columns: new[] { "ActorUserId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_audit_log_TenantId_CreatedAt",
                table: "audit_log",
